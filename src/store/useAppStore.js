...
const STORAGE_KEY = 'comparing_percentages_progress_v1';
...
export const useAppStore = create((set, get) => ({
  ...
  advanceQuestion: () => {
    ...
    if (isWorldFinished) {
      ...
      if (totalStars >= 10) badges.add('Percent Pro');
      if (activeWorldId >= 4) badges.add('Fair Comparer');
      if (activeWorldId >= 7) badges.add('Deal Detective');
